...
struct InboxFolder: Identifiable, Hashable {
    ...
    static let mockFolders: [InboxFolder] = [
        ...
        InboxFolder(id: "for_aknowledge", name: "For aknowledge", iconName: "eye", incomingCounter: 0, badgeColor: .gray),
        ...
        InboxFolder(id: "returned_by_me", name: "Returned by me", iconName: "arrow.uturn.backward", incomingCounter: 1, badgeColor: .yellow),
        InboxFolder(id: "returned_to_me", name: "Returned to me", iconName: "arrow.uturn.forward", incomingCounter: 0, badgeColor: .gray),
